...
/**Story Class:
 Purpose: The Story class manages the overall structure and flow of the interactive story. It orchestrates the loading of story nodes from YAML files, facilitates navigation between nodes based on user choices, and maintains the current state of the story progression.
 Responsibilities:
